...
public class ConwaysGameOfLife extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame game = new ConwaysGameOfLife();                      // es "game" de clase Thread o de clase JFrame??
        ...
        );     // seguramente fija la ventana enmedio
    ...
    public ConwaysGameOfLife() {
        ...
        mi_game_stop.setEnabled(false);                     // desactiva el elemento del menú
